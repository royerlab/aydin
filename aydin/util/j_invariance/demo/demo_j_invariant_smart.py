...
from aydin.io.datasets import normalise, add_noise, newyork, cropped_newyork
...
def demo_j_invariant_smart(image, display=True):
    """
...
if __name__ == "__main__":
    demo_j_invariant_smart(cropped_newyork(crop_amount=470))
