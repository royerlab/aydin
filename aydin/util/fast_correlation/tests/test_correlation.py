"""Tests for fast correlation implementations."""
...
from aydin.util.fast_correlation.tests.compute_correlation import (
...
def test_correlation_type_support():
    """Test correlation implementations handle various NumPy dtypes."""
...
def test_correlation_different_sizes():
    """Test correlation with various kernel sizes and shapes."""
...
def test_compute_correlation(method):
    """Test correlation for a given dimensionality against SciPy reference."""
...
def _test_compute_correlation_type_support(_fun_):
    """Test correlation with various numeric dtypes."""
    image = small_newyork()
...
def _test_compute_correlation_different_sizes(_fun_):
    """Test correlation with various kernel sizes and anisotropic shapes."""
    sizes = [1, 3, 5, 7, 17, 31]
...
def _run_test_for_type(_fun_, image, decimal=3):
    """Run correlation and compare against SciPy for a given dtype."""
    kernel = rand(3, 5)
