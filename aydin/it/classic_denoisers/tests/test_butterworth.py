"""Tests for the Butterworth denoiser."""
...
def test_butterworth():
    """Test Butterworth denoiser on a 2D image achieves minimum SSIM."""
...
def test_butterworth_anisotropy():
    """Test that Butterworth detects anisotropic frequency cutoffs."""
...
def test_butterworth_nd():
    """Test Butterworth denoiser on 1D through 4D inputs."""
