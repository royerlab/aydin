"""Demo script for 2D total variation (TV) denoising with auto-calibration."""
...
def demo_tv(image, do_add_noise=True, display=True):
    """Denoise a 2D image using auto-calibrated total variation regularization."""
    ...
    if display:
        ...
        plt.savefig(os.path.join(_DEMO_RESULTS, 'classic_tv_2D.png'))
