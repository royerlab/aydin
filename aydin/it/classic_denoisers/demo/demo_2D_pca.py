"""Demo script for 2D PCA-based denoising with auto-calibration."""
...
def demo_pca(image, display=True):
    """Denoise a 2D image using auto-calibrated PCA patch-based filtering."""
    ...
    if display:
        ...
        plt.savefig(os.path.join(_DEMO_RESULTS, 'classic_pca_2D.png'))
