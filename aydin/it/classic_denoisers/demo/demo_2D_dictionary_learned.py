"""Demo script for 2D learned-dictionary denoising with auto-calibration."""
...
def demo_dictionary_learned(image, display=True):
    """Denoise a 2D image using auto-calibrated learned-dictionary sparse coding."""
    ...
    if display:
        ...
        plt.savefig(os.path.join(_DEMO_RESULTS, 'classic_dictionary_learned_2D.png'))
