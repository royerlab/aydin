"""Tests for ImageTranslatorFGR on n-dimensional inputs (2D, 3D, 4D)."""
...
def test_it_fgr_gbm_2D_batchdims():
    """Test FGR with LightGBM regressor on 2D input with batch dimensions."""
...
def test_it_fgr_gbm_3D_batchdims():
    """Test FGR with LightGBM regressor on 3D input with batch dimensions."""
    Log.set_log_max_depth(2)
    it_fgr_nD(
        3,
        48,
...
def test_it_fgr_gbm_4D_batchdims():
    """Test FGR with LightGBM regressor on 4D input with batch dimensions."""
    Log.set_log_max_depth(2)
    it_fgr_nD(
        4,
        48,
...
def n(image):
    ...
    -------
    numpy.ndarray
        Float32 image with intensities in [0, 1].
    """
