"""Tests for ImageTranslatorFGR save/load round-trip functionality."""
...
def test_saveload_heavy(regressor, min_psnr, min_ssim):
    """Test FGR save/load round-trip with heavy regressors."""
    saveload(
...
def test_saveload_CB():
    """Test FGR save/load round-trip with CatBoost regressor."""
    saveload(
...
def saveload(generator, regressor, min_psnr=22, min_ssim=0.75):
    """Train, save, load, and verify an FGR translator preserves quality.
