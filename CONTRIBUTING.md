...
Releases use **calendar versioning** (`YYYY.M.D`) and go through a PR-based flow.
You need the [GitHub CLI](https://cli.github.com) (`gh`) installed and authenticated.
...
4. A CI workflow (`release.yml`) automatically creates a git tag and
