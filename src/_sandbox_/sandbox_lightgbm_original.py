...
from skimage.data import camera, hubble_deep_field, chelsea, coins
from skimage.exposure import rescale_intensity
from skimage.restoration import estimate_sigma, denoise_nl_means, denoise_tv_bregman, denoise_wavelet
