...
def discs(shape=(512,512), radius= 10, num=512, fill=False, image=None):
...
def noise_example():
    ...
    plt.plot(correlation(image)[0][:plot_length])
    plt.show()

    print("noise  %d,%d " % correlation_distance(image))


def camastro_example():
    camera = data.camera()
    ...
    plt.plot(correlation(camera)[0][:plot_length])
    plt.plot(correlation(camera)[1][:plot_length])
    plt.plot(correlation(astronaut)[0][:plot_length])
    plt.plot(correlation(astronaut)[1][:plot_length])
    plt.show()
...
def clock_example():
    ...
    plt.plot(correlation(clock)[0][:plot_length])
    plt.plot(correlation(clock)[1][:plot_length])
    plt.show()

    print("noise  %d,%d " % correlation_distance(clock))
...
def coins_example():
    ...
    plt.plot(correlation(coins)[0][:plot_length])
    plt.plot(correlation(coins)[1][:plot_length])
    plt.show()

    print("noise  %d,%d " % correlation_distance(coins))
...
def discs_example():
    ...
    plt.plot(correlation(discs1)[0][:plot_length])
    plt.plot(correlation(discs2)[0][:plot_length])
    plt.plot(correlation(discs3)[0][:plot_length])
    plt.show()
...
def lines_example():
    ...
    plt.plot(correlation(lines1)[0][:plot_length])
    plt.plot(correlation(lines2)[0][:plot_length])
    plt.plot(correlation(lines3)[0][:plot_length])
    plt.show()
...
def cells_example():
    ...
    plt.plot(correlation(cells)[0][:plot_length])
    plt.plot(correlation(cells)[1][:plot_length])
    plt.show()
...
def dmel_example():
    ...
    plt.plot(correlation(cells)[0][:plot_length])
    plt.plot(correlation(cells)[1][:plot_length])
    plt.plot(correlation(cells)[2][:plot_length])
    plt.show()
