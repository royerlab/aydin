"""Tests for shape, percentile, and min-max normalisers."""
...
def test_shape_norm_with_channels():
    """Test shape normalisation with channel dimensions."""
...
def test_shape_norm_without_channels():
    """Test shape normalisation without channel dimensions."""
...
def test_shape_norm_with_singleton_dim():
    """Test shape normalisation with a singleton spatial dimension."""
...
def test_percentile_normaliser():
    """Test percentile normaliser round-trip on a real image."""
...
def _test_percentile_normaliser_internal(input_path):
    """Test percentile normaliser roundtrip on a given image path."""
...
def test_minmax_normaliser():
    """Test min-max normaliser round-trip on a real image."""
    input_path = examples_single.noisy_fountain.get_path()
...
def _test_minmax_normaliser_internal(input_path):
    """Test min-max normaliser roundtrip on a given image path."""
    array, metadata = imread(input_path)
    array = array[0]
    print(array.shape)
