"""Demo script for 2D Butterworth low-pass filter denoising with auto-calibration."""
...
def demo_butterworth(image, do_add_noise=True, display=True):
    """Denoise a 2D image using auto-calibrated Butterworth low-pass filtering."""
    ...
    if display:
        ...
        plt.savefig(os.path.join(_DEMO_RESULTS, 'classic_butterworth_2D.png'))
