"""Demo script for 2D block-matching n-dimensional (BMND) denoising with auto-calibration."""
...
def demo_bmnd(image, display=True):
    """Denoise a 2D image using auto-calibrated block-matching n-dimensional filtering."""
    ...
    if display:
        ...
        plt.savefig(os.path.join(_DEMO_RESULTS, 'classic_bmnd_2D.png'))
