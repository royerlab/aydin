"""Demo script for 2D Gaussian mixture (GM) denoising with auto-calibration."""
...
def demo_gm(image, display=True):
    """Denoise a 2D image using auto-calibrated Gaussian mixture filtering."""
    ...
    if display:
        ...
        plt.savefig(os.path.join(_DEMO_RESULTS, 'classic_gm_2D.png'))
